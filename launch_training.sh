...
env CUDA_VISIBLE_DEVICES=0 nohup bash -c "source /home/yeblad/anaconda3/bin/activate rsna_kaggle && python scripts/train_eric3d_optimized.py \
    --data-dir $DATA_DIR \
...
env CUDA_VISIBLE_DEVICES=1 nohup bash -c "source /home/yeblad/anaconda3/bin/activate rsna_kaggle && python scripts/train_eric3d_optimized.py \
    --data-dir $DATA_DIR \
    --labels-csv $LABELS_CSV \
    --cv-dir $CV_DIR \
    --fold $FOLD \
...
echo "Check processes: ps aux | grep train_eric3d"
echo ""
